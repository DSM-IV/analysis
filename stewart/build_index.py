...
<meta name="description" content="Stewart, Calculus 9판 12.6·14–16장(다변수 미적분·중적분·벡터해석)의 정의·정리를 한국어로 해석하고 예제를 자체 풀이한 교재 노트. 강의 노트(미적분학 2)와 별도로 구성.">
<meta name="keywords" content="Stewart, Calculus, 9판, 미적분학 2, 다변수 미적분, 편도함수, 중적분, 벡터해석, 예제 풀이, 한국어 해석">
...
<header>
  <p class="subtitle">Stewart · Calculus 9e</p>
...
<main id="main-content">
  <p class="intro-text"><a href="exercises/index.html">연습문제와 해설</a> — §12.6, §14.1–14.8, §15.1–15.9, §16.1–16.9 일반 Exercises · 한국어·영어 단계별 풀이.</p>
...
<footer class="site-footer">
  ...
  <p class="footer-copy">Stewart, <em>Calculus</em>, 9th ed. (Cengage) 의 내용을 학습 목적으로 재서술·해석한 개인 노트입니다. 원문 텍스트·그림은 수록하지 않습니다. &copy; 2025–2026 DDALKKAK.</p>
</footer>
